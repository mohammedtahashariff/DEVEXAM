...
export const getAllAssessments = async (req: AuthenticatedRequest, res: Response) => {
  try {
...
export const createAssessment = async (req: AuthenticatedRequest, res: Response) => {
  try {
    ...
    let existing = await prisma.assessment.findUnique({ where: { code } });
    while (existing) {
      code = generateAssessmentCode();
      existing = await prisma.assessment.findUnique({ where: { code } });
    }
...
export const duplicateAssessment = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { id } = req.params;
...
export const deleteAssessment = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { id } = req.params;
